...
namespace HealthBloggie.Web.Controllers
{
    public class BlogController : Controller
    {
        ...
        private readonly IBlogPostLikeRepositories blogPostLikeRepository;
        private readonly SignInManager<IdentityUser> signInManager;
        private readonly UserManager<IdentityUser> userManager;
        private readonly IBlogPostCommentRepository blogPostCommentRepository;

        public BlogController(IBlogPostRepository blogPostRepository, IBlogPostLikeRepositories blogPostLikeRepository,
        ...
        public async Task<IActionResult> Index(BlogDetailsViewModel blogDetailsViewModel)
        {
            if (signInManager.IsSignedIn(User))
            {
                var domainModel = new BlogPostComment
                {
                    ...
                    Description = blogDetailsViewModel.CommentDesc,
